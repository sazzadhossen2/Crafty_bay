...
class CategoryProductIDController extends GetxController{
  ...
  Future<bool> getCategoryProductID(int id) async {
    bool isSuccess = true;
    _inProgress = true;
    update();
    final ResponceData responceData =
    await NetworkColler().getRequest(Urls.CategoryProductId(id));
    _inProgress=false;
